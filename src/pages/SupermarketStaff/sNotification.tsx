...
type NotificationType = "info" | "success" | "warning" | "product" | "ai" | "statistic"
...
const SupermarketNotification = () => {
    ...
    const fetchNotifications = useCallback(async () => {
        try {
            ...
            // const response = await supermarketService.getNotifications()
            ...
            const mockNotifications: NotificationItem[] = [
                {
                    ...
                    message: "Có 8 sản phẩm sắp hết hạn trong vòng 3 ngày tới cần xử lý.",
                ...
                },
                {
                    id: "2",
                    type: "ai",
                    title: "AI Token sắp hết",
                    message: "Số dư AI Token còn 150 credits, cần nạp thêm để tiếp tục sử dụng.",
                ...
                },
                {
                    id: "3",
                    type: "success",
                    title: "Đã xuất bản lô hàng mới",
                    message: "Lô hàng LOT-2024-001 đã được xuất bản thành công lên hệ thống.",
                ...
                },
                {
                    ...
                    message: "Doanh thu tuần này đạt 45.000.000đ, tăng 15% so với tuần trước.",
                ...
                },
                {
                    id: "5",
                    type: "warning",
                    title: "Cảnh báo giá thị trường",
                    message: "Giá tham khảo cho sản phẩm 'Sữa tươi' đã thay đổi đáng kể.",

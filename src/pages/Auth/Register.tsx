                    ...
                    <form onSubmit={onSubmit} className="space-y-6">
                        <div className="rounded-2xl border border-emerald-100 bg-gradient-to-br from-emerald-50/80 to-white p-4">
                            <div className="flex items-start gap-3">
                                ...
                                <div>
                                    <p className="font-semibold text-gray-800">Tài khoản khách hàng</p>
                                    <p className="mt-1 text-sm text-gray-600">
                                        Sau khi đăng ký tài khoản, bạn cần xác minh OTP qua email để kích hoạt.
                                    </p>
                                </div>
                            </div>
                        </div>
                        ...
                        <button
                            ...
                            className="w-full rounded-lg border border-gray-200 py-2.5 font-medium text-gray-600 hover:bg-gray-50"
                        >
                            Quay lại đăng nhập
                        </button>
                    </form>
    ...
    <div>
        ...
        <div className="relative">
            ...
            <input
                ...
                inputMode={inputMode}
                maxLength={maxLength}
                className={`mt-1 w-full rounded-lg border py-2 pr-4 ${icon ? "pl-9" : "pl-4"
                    } focus:ring-2 ${error ? "border-red-300 focus:ring-red-200" : "focus:ring-green-300"
                    }`}
            />
        </div>
        {error ? (
